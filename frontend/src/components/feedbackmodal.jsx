  ...
  return (
    <>
      ...
      >
        ...
        >
          <Divider sx={{ mt: 5 }} />
          <Typography sx={{ fontWeight: 'bold', fontSize: '16px', fontFamily: 'Poppins', mb: 2 }}>
            Let us know what you think
          </Typography>
          {/* <Typography sx={{ fontSize: '12px', fontFamily: 'Poppins', mb: 2 }}>
            We hope you’re loving Stallion Notes!
          </Typography> */}
          <Typography sx={{ fontSize: '12px', fontFamily: 'Poppins' }}>
            How engaging do you find the features of Stallion Notes (e.g., upload, sell, pre-purchase, etc)?<br />
            5 - extremely engaging<br />
            4 - very engaging<br />
            3 - engaging<br />
            2 - slightly engaging<br />
            1 - not engaging
          </Typography>
